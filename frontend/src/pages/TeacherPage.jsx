                  ...
                  <table className="w-full border-collapse rounded-xl overflow-hidden">
                    <thead className="bg-[#E38B52]/10">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left text-sm font-semibold text-[#170F49]">Year</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white/70">
                      {teacher.classes.map((classItem, index) => (
                        <tr key={index} className={index < teacher.classes.length - 1 ? "border-b border-[#E38B52]/10" : ""}>
                          ...
                          <td className="px-4 py-3 text-sm text-[#170F49]">{classItem.year}</td>
                        </tr>
                      ))}
                      {teacher.classes.length === 0 && (
                        <tr>
                          <td colSpan="2" className="px-4 py-3 text-sm text-center text-[#6F6C90]">
