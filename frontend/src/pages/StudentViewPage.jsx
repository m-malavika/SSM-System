                  ...
                  {notifications.map((notification) => (
                    ...
                    >
                      ...
                      {notification.report_summary && (
                        <div className="mt-4 p-4 bg-gradient-to-br from-orange-50/60 to-orange-100/40 rounded-xl border border-[#E38B52]/20">
                          <h4 className="text-sm font-bold text-[#C56930] mb-2 flex items-center gap-2">
